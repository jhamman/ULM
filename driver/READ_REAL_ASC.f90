SUBROUTINE READ_REAL_ASC(filename,zlen,xlen,ylen,XLLCORNER,YLLCORNER,cellsize,TEMP)
  ...
  CHARACTER*60 RCSID
  DATA RCSID/"$Id: READ_REAL_ASC.f90,v 1.1.1.1 2007/10/04 20:01:30 vicadmin Exp $"/

  ! Define local variables
  CHARACTER*200 filename
  INTEGER zlen,xlen,ylen
  REAL    XLLCORNER,YLLCORNER,cellsize
  REAL    TEMP(zlen,xlen,ylen), TEMP2(zlen,xlen,ylen)
  INTEGER K,J,I
