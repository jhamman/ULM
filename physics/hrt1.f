...
C  ACCOUNT FOR RESIDUE EFFECT ON CONDUCTIVITY
      ...
      ENDDO
         MXICE = SMC(1) - SH2O(1)
       dfmax1 = cnd_johns(stype,sh2o(1),mxice,smcmr,0.)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      HCPCT = SH2O(1)*CH2O + (1.0-SMCMR)*CSOIL + (SMCMR-SMC(1))*CAIR
     +        + ( SMC(1) - SH2O(1) ) * CICE
...
CC     +             ZSOIL, SMCMR, PSISAT, B, DT, 1, STYPE, 0.)
     +     ZSOIL, SMCMR, PSISAT, B, DT, 1, STYPE, 0.,IVERS,CKSOIL)
...
CC     +             ZSOIL,SMCMAX, PSISAT, B, DT, K,STYPE,QUARTZ)
     +     ZSOIL,SMCMAX, PSISAT, B, DT, K,STYPE,QUARTZ,IVERS,CKSOIL)
